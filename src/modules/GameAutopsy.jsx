...
 *
 * Full pipeline:
 *   PGN upload → chess.js parse → Super AI Consensus Engine → Vlad/Fabiano/Magnus/Hikaru debrief
 *
 * Tab order: Coaches → Critical → Move List
 * Critical list: AI consensus saved to localStorage("vlad_critical_list")
 * Move list: Raw chess.com moves, flags deviations from GM Plan
 */
...
Identify the 1-3 most critical turning points or mistakes.
...
    "side": "white",
    "actualMove": "exd5",
    "vlad": "1 short philosophical critique",
    "fabiano": "1 short positional critique",
    "magnus": "1 short intuitive critique",
    "hikaru": "1 short tactical critique",
    "superAI": "1-2 sentences: the synthesized custom best move for the Italian game plan."
  }
]`;
...
    const vladContext = `Game: ${parsed.white} vs ${parsed.black}. Result: ${parsed.result}. Player side: ${parsed.playerSide}. Deviations from plan: ${deviations}. Critical moments found: ${criticalMoves.length}. PGN: ${target}`;
    const gameContext = { ...parsed, summary: gameAnalysis.summary };
    const finalCoaches = { vlad: null, fabiano: null, magnus: null, hikaru: null };
...
            <p style={styles.headerSub}>AI Consensus Engine · Vlad · Fabiano · Magnus · Hikaru</p>
          </div>
        </div>
        {gameInfo && phase === "done" && (
