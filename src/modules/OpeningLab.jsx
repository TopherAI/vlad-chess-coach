...
const REPERTOIRE = [
  ...
  { id: 'duras-gambit', name: 'Dúras Gambit', subtitle: 'Blunder', color: '#3b82f6',
    moves: ['e4','Nf3','Bc4','d4','c3','O-O','h3','Re1'],
    ucis: ['e2e4','g1f3','f1c4','d2d4','c2c3','e1g1','h2h3','f1e1'] },
  ...
  { id: 'french', name: 'French', subtitle: 'Two Horses', color: '#6b7280',
    moves: ['e4','Nf3','Bc4','Nc3','d3','O-O','h3','a4','Re1'],
    ucis: ['e2e4','g1f3','f1c4','b1c3','d2d3','e1g1','h2h3','a2a4','f1e1'] },
